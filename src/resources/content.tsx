...
const social: Social = [
  ...
  // Import new icons in /once-ui/icons.ts
  {
    name: "GitHub",
    icon: "github",
    link: "https://github.com/ahmedzubairbd",
  },
  {
    name: "LinkedIn",
    icon: "linkedin",
    link: "https://www.linkedin.com/in/ahmedzubairbd/",
  },
  {
    name: "Threads",
    icon: "threads",
    link: "https://www.threads.com/@ahmedzubairbd",
  },
  {
    name: "Email",
    icon: "email",
...
const home: Home = {
  ...
  subline: (
    <>
      I'm {person.name}, a {person.role} at{" "}
      <Logo
        dark
        icon="/trademarks/wordmark-dark.svg"
        style={{ display: "inline-flex", top: "0.25em", marginLeft: "-0.25em" }}
      />
      , where I build intuitive
